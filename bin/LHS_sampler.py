...
def generate_lhstrainingset(template_dir = '.', seed=0, n_samples=20, n_dimensions=2, bounds=None, savefile = True):
    ...
    -----------
    template_dir : str
        The directory to which the training set will be saved
    seed : int
    ...
    if n_dimensions <1:
        raise ValueError("n_dimensions must be greater than 0")
...
def generate_lhsstarter(template_dir = '.', seed=0, n_samples=20, n_dimensions=2, bounds=None, savefile = True):
    ...
    -----------
    template_dir : str
        The directory to which the starter set will be saved
    seed : int
        The seed for the random number generator for reproducibility
    n_samples : int
        The number of samples to generate
